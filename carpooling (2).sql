...
--
-- Host: 127.0.0.1
-- Creato il: Feb 19, 2026 alle 11:23
...
CREATE TABLE `viaggio` (
  ...
  `nPostiOccupati` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
INSERT INTO `viaggio` (`idViaggio`, `cittaP`, `cittaD`, `dataOra`, `costo`, `tempo`, `bagagli`, `animali`, `nPosti`, `codiceFiscaleA`, `chiuso`, `nPostiOccupati`) VALUES
(1, 'Roma', 'Milano', '2026-03-01 08:30:00', 35, 360, 1, 0, 3, 'RSSMRA80A01F205X', 0, 0),
(2, 'Torino', 'Lione', '2026-03-05 14:00:00', 25, 240, 1, 1, 4, 'BNCGNN85B10L219Z', 0, 0),
(3, 'Napoli', 'Bari', '2026-03-10 10:00:00', 15, 180, 0, 0, 2, 'VRDLRA90C15H501U', 0, 0);
